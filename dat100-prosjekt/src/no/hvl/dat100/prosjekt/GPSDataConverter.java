...
public class GPSDataConverter {
	...
	public static int toSeconds(String timestr) {
		...
		// TODO
		// OPPGAVE - START
		// Lager en ny variabel for strengen som bare inneholder tid, og omgjør den til Integer
		String relevantTime = timestr.substring(TIME_STARTINDEX);
		
		String hrString = relevantTime.substring(0, 2);
		hr = Integer.parseInt(hrString);
		
		String minString = relevantTime.substring(3, 5);
		min = Integer.parseInt(minString);
		
		String secString = relevantTime.substring(6, 8);
